...
- `npm --prefix qa/devtools-qa-runner run smoke:lms` — failed because target deployment returned HTTP 502. Evidence: `qa/devtools-qa-runner/reports/devtools-qa-runner/lms-chatbot/latest/qa-report.md` shows `GET https://121.145.133.68.sslip.io/ -> 502`. This is a target outage, not a runner packaging failure.
