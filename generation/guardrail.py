...
_HELP_PATTERNS = [
    ...
    # 기능 묻기 / 할 줄 아. '어떤 기능'은 존재·제공을 물을 때만 역량 문의로 본다.
    # ("어떤 기능이 있나요/제공/가능" → help) 특정 기능의 정체를 묻는 "X는 어떤
    # 기능인가요?"(→ FAQ/RAG)가 가로채이지 않게 존재·제공 신호를 요구한다.
    r"(?:무슨|어떤)\s*기능[가-힣\s]{0,5}?(?:있|제공|지원|가능|할\s*수|돼|되나)|기능이?\s*뭐|할\s*줄\s*아",
    # "뭐/뭘/무엇/어떤 걸 ... 물어보면/여쭤"
